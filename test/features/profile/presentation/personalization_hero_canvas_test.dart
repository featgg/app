...
/// Sizes the render surface to the column width and [screenHeight] so the hero's
/// `MediaQuery`-derived frame budget has real room (a too-short window would clamp
/// the frame and defeat the conditional-fit check).
Future<void> _pump(WidgetTester tester, {required double screenHeight}) async {
...
void main() {
  group('PersonalizationHeroCanvas (spec §4 conditional-fit)', () {
