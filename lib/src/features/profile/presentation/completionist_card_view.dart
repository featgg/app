...
class _LoadingTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ClipRRect(
      key: Key('completionistLoading_$widgetId'),
      borderRadius: BorderRadius.circular(AppRadii.lg),
      child: AspectRatio(
...
/// the tile stays intentional and its options menu reachable: a trophy glyph at
/// the card footprint with the localized line beneath. Mirrors the collector
/// motif.
            ...
            child: Column(
              ...
              children: [
                Icon(
                  ...
                  key: Key('completionistEmptyMotif_$widgetId'),
